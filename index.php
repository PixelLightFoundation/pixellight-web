  ...
  <section class="invert-colors">
    <div class="container">
      <div class="col grid12 textcenter">
        ...
        <p>
          This website was launched as a replacement for the old one and is not yet complete. If you are looking for information about the engine, please
          make sure to read the <a href="post_sunray-on-the-horizon.php">relevant blog post</a> first. If you have any further questions, feel free to join our <a href="http://pixellight.org/forum/">
          forum</a> and discuss your enquiry.
        </p>
      </div>
    </div>
  </section>
        ...
        <div class="slider">
          <div class="item">
            ...
            <a href="#" class="caption">
              <span class="text">Complete rendering solution.</span>
            </a>
          </div>
          <div class="item">
            <img src="img/title_2.jpg" alt="" />
            <a href="#" class="caption">
              <span class="text">Powerful architecture.</span>
            </a>
          </div>
          <div class="item">
            <img src="img/title_3.jpg" alt="" />
            <a href="#" class="caption">
              <span class="text">Physics, scripting and more.</span>
            </a>
          </div>
          <div class="item">
...
<div id="content" class="wrapper-row wrapper-expand">
  ...
  <section class="container">
    ...
    <div class="col grid4 feature">
      ...
      <p class="small">
        PixelLight is licensed under the permissive <a href="http://opensource.org/licenses/MIT">MIT license</a>, allowing its use in all applications, commercial or not.
      </p>
    </div>
    <div class="col grid4 feature">
      <img src="img/xpf_logo.png" alt="" width="111" height="111" />
      <h3>Cross-platform</h3>
      <p class="small">The engine runs on Windows, Linux and soon on Mac OSX, both 32 and 64 bit architectures. Take your pick.</p>
    </div>
    <div class="col grid4 feature">
    ...
    <div class="col grid4 feature">
      ...
      <h3>Contribute</h3>
      <p class="small">
        Our team is open to new developers who want to make a contribution to this awesome project. <a href="contribute.php">Join now...</a>
      </p>
    </div>
    <div class="clear"></div>
  </section>
