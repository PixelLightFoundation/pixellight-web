...
?>
    ...
    <!--
		...
		<div class="col grid4 feature">
			...
			<h3>Windows</h3>
			<p class="small">Microsoft&reg; Windows&reg; binary SDK is available for download below. Runtime libraries are expecting Microsoft&reg; Visual Studio 2013.</p>
			<p class="small"><a href="#">32 bit</a> | <a href="#">64 bit</a></p>
		</div>
		<div class="col grid4 feature">
			<img src="img/oss_logo.png" alt="" width="111" height="111">
			<h3>Linux</h3>
			<p class="small">Prebuilt .deb packages are awailable for Ubuntu 13.10 and compatible systems. For other distributions, consider downloading the <a href="#">source code</a>.</p>
			<p class="small"><a href="#">32 bit</a> | <a href="#">64 bit</a></p>
		</div>
		<div class="col grid4 feature">
			<img src="img/oss_logo.png" alt="" width="111" height="111">
