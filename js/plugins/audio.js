...
(function(audiojs, audiojsInstance, container) {
  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      createPlayer: {
        markup: '<div class="play-pause"><span class="play icon-play"></span><span class="pause icon-pause"></span><span class="loading icon-cycle"></span><span class="error icon-cross"></span></div><div class="scrubber"><div class="progress"></div><div class="loaded"></div></div><div class="time"><em class="played">00:00</em>/<strong class="duration">00:00</strong></div><div class="error-message"></div>',
